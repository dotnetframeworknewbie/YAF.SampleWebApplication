<%@ Page Title="Chat Room" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="YAF.SampleWebApplication.Chat" %>
...
IntervalVal = setInterval("ShowTitleAlert('Chat Room', '" + Notification + "')", 800);
...
Welcome to Chat Room <span id='spanUser' class="font-weight-bold"></span>
